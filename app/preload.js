...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  jarvis: {
    ...
    getSessionTimeline: (sessionId, page) =>
      page === undefined
        ...
        : ipcRenderer.invoke("jarvis:memory:session-timeline", sessionId, page),
    getSessionTimelineStatus: (sessionId) =>
      ipcRenderer.invoke("jarvis:memory:session-timeline-status", sessionId),
    ...
    getStorageStatus: () => ipcRenderer.invoke("jarvis:storage:status"),
    pickStorageDirectory: () => ipcRenderer.invoke("jarvis:storage:pick-directory"),
    migrateStorage: (input) => ipcRenderer.invoke("jarvis:storage:migrate", input),
  ...
  onMeetingTranscriptionInputRejected: registerListener(
