...
import {
  ...
  participantReviewActionLabel,
  safeStringArray,
  safeLegacySuggestions,
  analysisErrorMessage,
} from "./memory/presentation";
// Compatibility for existing consumers; new code imports presentation helpers directly.
// eslint-disable-next-line react-refresh/only-export-components
export { groupConfirmedSpeakerPeople } from "./memory/presentation";
export type { JarvisVisibleSpeakerGroup } from "./memory/presentation";
      ...
      <main className="jarvis-scroll-region min-w-0 overflow-y-scroll p-6 lg:col-span-2">
        ...
        <div className="flex flex-col">
          ...
          <SessionSummaryCard
            ...
            refresh={speakerProcessing?.summaryRefresh}
            loading={loading}
            summaryInputReady={summaryInputReady}
            decisions={decisions}
