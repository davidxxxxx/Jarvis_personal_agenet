...
`9bfe707ebe9e7d34e4df70bb94a64369e7ea7ce3`; physical-device, private-fixture, and live-network
...
| ------------------- | ----------------------------------------------------------------------------------------------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AUTO_REGRESSION     | Full Jarvis main and renderer regression                                                        | `PASS`    | observed=2026-07-17T15:49:28+08:00; commit=9bfe707ebe9e7d34e4df70bb94a64369e7ea7ce3; evidence=G:\Jarvis\.release-evidence\phase-4\20260717-154928-9bfe707e\auto-regression.md             | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; $env:npm_config_cache='G:\Jarvis\.runtime-cache\npm'; npm run test:jarvis`                                                                                                                                     |
| STATIC_GATES        | Typecheck, lint, i18n, renderer build, and patch hygiene                                        | `PASS`    | observed=2026-07-17T15:49:28+08:00; commit=9bfe707ebe9e7d34e4df70bb94a64369e7ea7ce3; evidence=G:\Jarvis\.release-evidence\phase-4\20260717-154928-9bfe707e\static-gates.md                | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; $env:npm_config_cache='G:\Jarvis\.runtime-cache\npm'; npm run typecheck; npm run lint; npm run i18n:check; npm run build:renderer; Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime; git diff --check` |
| VIRTUAL_CAPTURE_3H  | Three-hour deterministic capture, FLAC, migration, and retention endurance                      | `PASS`    | observed=2026-07-17T15:49:28+08:00; commit=9bfe707ebe9e7d34e4df70bb94a64369e7ea7ce3; evidence=G:\Jarvis\.release-evidence\phase-4\20260717-154928-9bfe707e\virtual-capture-3h.md          | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run test:jarvis:capture-soak`                                                                                                                                                                              |
| VIRTUAL_RESOURCE_3H | Three-hour deterministic CPU, GPU-pressure, preview, and queue governance endurance             | `PASS`    | observed=2026-07-17T15:49:28+08:00; commit=9bfe707ebe9e7d34e4df70bb94a64369e7ea7ce3; evidence=G:\Jarvis\.release-evidence\phase-4\20260717-154928-9bfe707e\virtual-resource-3h.md         | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run test:jarvis:resource-soak`                                                                                                                                                                             |
| WINDOWS_PACKAGE     | Unsigned Windows package and package-safety scan                                                | `PASS`    | observed=2026-07-17T15:49:28+08:00; commit=9bfe707ebe9e7d34e4df70bb94a64369e7ea7ce3; evidence=G:\Jarvis\.release-evidence\phase-4\20260717-154928-9bfe707e\windows-package-native-abi.md  | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; $env:npm_config_cache='G:\Jarvis\.runtime-cache\npm'; npm run build:win:unsigned`                                                                                                                              |
| NATIVE_ABI          | Source Node ABI restore and packaged Electron ABI/bindings smoke                                | `PASS`    | observed=2026-07-17T15:49:28+08:00; commit=9bfe707ebe9e7d34e4df70bb94a64369e7ea7ce3; evidence=G:\Jarvis\.release-evidence\phase-4\20260717-154928-9bfe707e\windows-package-native-abi.md  | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; node --test test/jarvis/NativeAbiPackaging.test.js test/jarvis/PackagedRuntimeDependencies.test.js; npm run build:win:unsigned`                                                                                |
| PACKAGED_OFFLINE    | Unpacked executable launch with process-scoped offline transport                                | `PASS`    | observed=2026-07-17T15:49:28+08:00; commit=9bfe707ebe9e7d34e4df70bb94a64369e7ea7ce3; evidence=G:\Jarvis\.release-evidence\phase-4\20260717-154928-9bfe707e\packaged-offline-restart.md    | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run smoke:win:unpacked -- --runtime-root G:\Jarvis\.runtime-cache\packaged-smoke`                                                                                                                          |
| PACKAGED_RESTART    | Fresh isolated-profile real session persistence, reopen, and no-duplicate smoke                 | `PASS`    | observed=2026-07-17T15:49:28+08:00; commit=9bfe707ebe9e7d34e4df70bb94a64369e7ea7ce3; evidence=G:\Jarvis\.release-evidence\phase-4\20260717-154928-9bfe707e\packaged-offline-restart.md    | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run smoke:win:unpacked -- --runtime-root G:\Jarvis\.runtime-cache\packaged-smoke`                                                                                                                          |
...
| REAL_MIC            | Physical microphone selection, dual capture, interruption recovery, and wall-clock resource UAT | `BLOCKED` | blocker=requires an identified physical microphone and coordinated tester consent for recording plus controlled disconnect actions; no physical audio was captured by the automated gate. | `& 'G:\Jarvis\.worktrees\jarvis-all-day-runtime\app\dist\win-unpacked\Jarvis Memory.exe' --user-data-dir='G:\Jarvis\.release-evidence\phase-4\<run-id>\profiles\real-mic'`                                                                                                                                                                   |
| CUDA_WHISPER        | Verified real CUDA Whisper inference, fallback, and GPU-pressure UAT                            | `BLOCKED` | blocker=the candidate has no recorded verified CUDA runtime/model installation and no real GPU inference evidence; deterministic CUDA-failure simulation is not a substitute.             | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run jarvis:cuda:self-test`                                                                                                                                                                                 |
...
| MINIMAX_LIVE        | Live MiniMax analysis and daily-digest network UAT under the hard monthly budget                | `BLOCKED` | blocker=no authorized live provider request or billable usage was performed for this candidate; offline, budget, and redaction logic is covered by automated tests only.                  | `& 'G:\Jarvis\.worktrees\jarvis-all-day-runtime\app\dist\win-unpacked\Jarvis Memory.exe' --user-data-dir='G:\Jarvis\.release-evidence\phase-4\<run-id>\profiles\minimax-live'`                                                                                                                                                               |
