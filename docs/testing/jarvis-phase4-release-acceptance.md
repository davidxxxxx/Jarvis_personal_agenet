...
forward. The automated rows below were executed against runtime candidate
`e68637b522d50b0e50c3a19c65fdf29a52f45b7a`; physical-device, private-fixture, and live-network
rows remain blocked until their named prerequisites are available.
...
| ------------------- | ----------------------------------------------------------------------------------------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AUTO_REGRESSION     | Full Jarvis main and renderer regression                                                        | `PASS`    | observed=2026-08-03T13:20:18+08:00; commit=e68637b522d50b0e50c3a19c65fdf29a52f45b7a; evidence=G:\Jarvis\.release-evidence\phase-4\0.2.0-rc.1\release-acceptance.md                           | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; $env:npm_config_cache='G:\Jarvis\.runtime-cache\npm'; npm run test:jarvis`                                                                               |
| STATIC_GATES        | Typecheck, lint, i18n, renderer build, and patch hygiene                                        | `PASS`    | observed=2026-08-03T13:20:18+08:00; commit=e68637b522d50b0e50c3a19c65fdf29a52f45b7a; evidence=G:\Jarvis\.release-evidence\phase-4\0.2.0-rc.1\release-acceptance.md                           | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run typecheck; npm run lint; npm run i18n:check; npm run build:renderer; Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime; git diff --check` |
| VIRTUAL_CAPTURE_3H  | Three-hour deterministic capture, FLAC, migration, and retention endurance                      | `PASS`    | observed=2026-08-03T13:20:18+08:00; commit=e68637b522d50b0e50c3a19c65fdf29a52f45b7a; evidence=G:\Jarvis\.release-evidence\phase-4\0.2.0-rc.1\release-acceptance.md                           | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run test:jarvis:capture-soak`                                                                                                                        |
| VIRTUAL_RESOURCE_3H | Three-hour deterministic CPU, GPU-pressure, preview, and queue governance endurance             | `PASS`    | observed=2026-08-03T13:20:18+08:00; commit=e68637b522d50b0e50c3a19c65fdf29a52f45b7a; evidence=G:\Jarvis\.release-evidence\phase-4\0.2.0-rc.1\release-acceptance.md                           | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run test:jarvis:resource-soak`                                                                                                                       |
| WINDOWS_PACKAGE     | Unsigned Windows package and package-safety scan                                                | `PASS`    | observed=2026-08-03T13:20:18+08:00; commit=e68637b522d50b0e50c3a19c65fdf29a52f45b7a; evidence=G:\Jarvis\.release-evidence\phase-4\0.2.0-rc.1\release-acceptance.md                           | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; npm run build:win:unsigned -- --output-dir G:\Jarvis\releases\0.2.0-rc.1`                                                                                                                                               |
| NATIVE_ABI          | Source Node ABI restore and packaged Electron ABI/bindings smoke                                | `PASS`    | observed=2026-08-03T13:20:18+08:00; commit=e68637b522d50b0e50c3a19c65fdf29a52f45b7a; evidence=G:\Jarvis\.release-evidence\phase-4\0.2.0-rc.1\release-acceptance.md                           | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; node --test test/jarvis/NativeAbiPackaging.test.js test/jarvis/PackagedRuntimeDependencies.test.js; npm run build:win:unsigned -- --output-dir G:\Jarvis\releases\0.2.0-rc.1`                                           |
| PACKAGED_OFFLINE    | Unpacked executable launch with process-scoped offline transport                                | `PASS`    | observed=2026-08-03T13:20:18+08:00; commit=e68637b522d50b0e50c3a19c65fdf29a52f45b7a; evidence=G:\Jarvis\.release-evidence\phase-4\0.2.0-rc.1\release-acceptance.md                           | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; npm run smoke:win:unpacked -- --runtime-root G:\Jarvis\.runtime-cache\packaged-smoke --executable 'G:\Jarvis\releases\0.2.0-rc.1\win-unpacked\Jarvis Memory.exe'`                                                       |
| PACKAGED_RESTART    | Fresh isolated-profile real session persistence, reopen, and no-duplicate smoke                 | `PASS`    | observed=2026-08-03T13:20:18+08:00; commit=e68637b522d50b0e50c3a19c65fdf29a52f45b7a; evidence=G:\Jarvis\.release-evidence\phase-4\0.2.0-rc.1\release-acceptance.md                           | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; npm run smoke:win:unpacked -- --runtime-root G:\Jarvis\.runtime-cache\packaged-smoke --executable 'G:\Jarvis\releases\0.2.0-rc.1\win-unpacked\Jarvis Memory.exe'`                                                       |
| LEGACY_FIXTURE      | Real-shaped copied legacy database migration, interruption, restart, and idempotence            | `PASS`    | observed=2026-08-03T13:20:18+08:00; commit=e68637b522d50b0e50c3a19c65fdf29a52f45b7a; evidence=G:\Jarvis\.release-evidence\phase-4\0.2.0-rc.1\release-acceptance.md                           | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; node --test test/jarvis/V58ReleaseMigrationGate.test.js`                                                                                                                                                                |
