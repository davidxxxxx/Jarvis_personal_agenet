...
forward. This evidence revision records the automated gates actually run against hardened candidate
`293bb057fa28b2667516c5c5e445783ea1874659`. Physical-device, private-fixture, external legacy-data,
and live-network rows remain blocked until their named prerequisites are available.
...
| ------------------- | ----------------------------------------------------------------------------------------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AUTO_REGRESSION     | Full Jarvis main and renderer regression                                                        | `PASS`    | observed=2026-08-03T14:31:36+08:00; commit=293bb057fa28b2667516c5c5e445783ea1874659; evidence=G:\Jarvis\.release-evidence\phase-4\rc1-293bb057-20260803\auto-regression-static\SUMMARY.txt; result=main 2339 passed with 3 platform skips and renderer 434 passed.                                                    | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; $env:npm_config_cache='G:\Jarvis\.runtime-cache\npm'; npm run test:jarvis`                                                                                                      |
| STATIC_GATES        | Typecheck, lint, i18n, renderer build, and patch hygiene                                        | `PASS`    | observed=2026-08-03T14:31:36+08:00; commit=293bb057fa28b2667516c5c5e445783ea1874659; evidence=G:\Jarvis\.release-evidence\phase-4\rc1-293bb057-20260803\auto-regression-static\SUMMARY.txt; result=all canonical static gates exited 0 and the worktree remained clean.                                               | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run typecheck; npm run lint; npm run i18n:check; npm run build:renderer; npm run release:check; Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime; git diff --check` |
| VIRTUAL_CAPTURE_3H  | Three-hour deterministic capture, FLAC, migration, and retention endurance                      | `PASS`    | observed=2026-08-03T14:24:17+08:00; commit=293bb057fa28b2667516c5c5e445783ea1874659; evidence=G:\Jarvis\.release-evidence\phase-4\rc1-293bb057-20260803\capture-model\summary.md; result=3 of 3 passed across exactly 3 virtual hours with zero orphaned or corrupt chunks and final owned resources at zero.         | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run test:jarvis:capture-soak`                                                                                                                                               |
| VIRTUAL_RESOURCE_3H | Three-hour deterministic CPU, GPU-pressure, preview, and queue governance endurance             | `PASS`    | observed=2026-08-03T14:24:24+08:00; commit=293bb057fa28b2667516c5c5e445783ea1874659; evidence=G:\Jarvis\.release-evidence\phase-4\rc1-293bb057-20260803\resource-migration-memory\SUMMARY.md; result=1 of 1 passed with 181 final jobs, zero loss, no heavy starts while external GPU was busy, and complete drain.   | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run test:jarvis:resource-soak`                                                                                                                                              |
| WINDOWS_PACKAGE     | Unsigned Windows package and package-safety scan                                                | `PASS`    | observed=2026-08-03T14:37:51+08:00; commit=293bb057fa28b2667516c5c5e445783ea1874659; evidence=G:\Jarvis\.release-evidence\phase-4\rc1-293bb057-20260803\package\SUMMARY.md; result=guarded unsigned installer and unpacked application built in a new G-drive directory and passed final package-safety verification. | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; npm run build:win:unsigned -- --output-dir G:\Jarvis\releases\0.2.0-rc.1`                                                                                                                                                                      |
| NATIVE_ABI          | Source Node ABI restore and packaged Electron ABI/bindings smoke                                | `PASS`    | observed=2026-08-03T14:38:56+08:00; commit=293bb057fa28b2667516c5c5e445783ea1874659; evidence=G:\Jarvis\.release-evidence\phase-4\rc1-293bb057-20260803\package\SUMMARY.md; result=source Node ABI 137 and packaged Electron ABI 145 each loaded once; source binding was restored after build.                       | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; node scripts\verify-native-abi.js (Get-Command node.exe).Source (Resolve-Path node_modules\better-sqlite3) (Resolve-Path node_modules\better-sqlite3\build\Release\better_sqlite3.node) 137 source-node`                                       |
| PACKAGED_OFFLINE    | Unpacked executable launch with process-scoped offline transport                                | `PASS`    | observed=2026-08-03T14:39:47+08:00; commit=293bb057fa28b2667516c5c5e445783ea1874659; evidence=G:\Jarvis\.release-evidence\phase-4\rc1-293bb057-20260803\package\SUMMARY.md; result=two isolated launches remained offline, initialized the native database, completed one renderer session, and exited gracefully.    | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; npm run smoke:win:unpacked -- --runtime-root G:\Jarvis\.runtime-cache\packaged-smoke --executable 'G:\Jarvis\releases\0.2.0-rc.1\win-unpacked\Jarvis Memory.exe' --expected-commit 293bb057fa28b2667516c5c5e445783ea1874659`                   |
| PACKAGED_RESTART    | Fresh isolated-profile real session persistence, reopen, and no-duplicate smoke                 | `PASS`    | observed=2026-08-03T14:39:47+08:00; commit=293bb057fa28b2667516c5c5e445783ea1874659; evidence=G:\Jarvis\.release-evidence\phase-4\rc1-293bb057-20260803\package\SUMMARY.md; result=the same fresh profile reopened and the terminal smoke session existed exactly once before and after restart.                      | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; npm run smoke:win:unpacked -- --runtime-root G:\Jarvis\.runtime-cache\packaged-smoke --executable 'G:\Jarvis\releases\0.2.0-rc.1\win-unpacked\Jarvis Memory.exe' --expected-commit 293bb057fa28b2667516c5c5e445783ea1874659`                   |
| LEGACY_FIXTURE      | Real-shaped copied legacy database migration, interruption, restart, and idempotence            | `BLOCKED` | blocker=no version-pinned external real-world legacy SQLite fixture is available; generated file-backed v54/v56/v57 fixtures validate migrations but do not replace this prerequisite; full legacy and migration acceptance remains blocked on this gate.                                                             | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime; rg --files -g '*legacy*.sqlite' -g '*legacy*.sqlite3' -g '*legacy*.db' app\test G:\Jarvis\.release-fixtures`                                                                                                                                       |
| REAL_MIC            | Physical microphone selection, dual capture, interruption recovery, and wall-clock resource UAT | `BLOCKED` | blocker=requires explicit tester consent for physical recording and two coordinated disconnect/reconnect actions; this candidate did not capture physical audio during automated acceptance.                                                                                                                          | `& 'G:\Jarvis\releases\0.2.0-rc.1\win-unpacked\Jarvis Memory.exe' --user-data-dir='G:\Jarvis\.release-evidence\phase-4\<run-id>\profiles\real-mic'`                                                                                                                                                           |
| CUDA_WHISPER        | Verified real CUDA Whisper inference, fallback, and GPU-pressure UAT                            | `BLOCKED` | blocker=no candidate-specific real CUDA inference was authorized or recorded; deterministic GPU-pressure and CUDA-failure simulations do not establish physical CUDA execution.                                                                                                                                       | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run jarvis:cuda:self-test`                                                                                                                                                  |
...
| MINIMAX_LIVE        | Live MiniMax analysis and daily-digest network UAT under the hard monthly budget                | `BLOCKED` | blocker=no authorized billable provider request was performed for this candidate; offline, budget, schema-compatibility, retry, and redaction logic are covered by automated tests only.                                                                                                                              | `& 'G:\Jarvis\releases\0.2.0-rc.1\win-unpacked\Jarvis Memory.exe' --user-data-dir='G:\Jarvis\.release-evidence\phase-4\<run-id>\profiles\minimax-live'`                                                                                                                                                       |
