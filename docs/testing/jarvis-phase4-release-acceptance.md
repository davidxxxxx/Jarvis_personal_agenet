...
forward. This pre-gate revision intentionally records every automated row as `NOT RUN`.
A later evidence-only commit records the exact hardened candidate SHA and actual results;
physical-device, private-fixture, and live-network rows remain blocked until their named prerequisites are available.
...
| ------------------- | ----------------------------------------------------------------------------------------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AUTO_REGRESSION     | Full Jarvis main and renderer regression                                                        | `NOT RUN` | Not executed: hardened RC candidate gates have not yet run.                                                                                                                                                                                               | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; $env:npm_config_cache='G:\Jarvis\.runtime-cache\npm'; npm run test:jarvis`                                                                               |
| STATIC_GATES        | Typecheck, lint, i18n, renderer build, and patch hygiene                                        | `NOT RUN` | Not executed: hardened RC candidate gates have not yet run.                                                                                                                                                                                               | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run typecheck; npm run lint; npm run i18n:check; npm run build:renderer; Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime; git diff --check` |
| VIRTUAL_CAPTURE_3H  | Three-hour deterministic capture, FLAC, migration, and retention endurance                      | `NOT RUN` | Not executed: hardened RC candidate gates have not yet run.                                                                                                                                                                                               | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run test:jarvis:capture-soak`                                                                                                                        |
| VIRTUAL_RESOURCE_3H | Three-hour deterministic CPU, GPU-pressure, preview, and queue governance endurance             | `NOT RUN` | Not executed: hardened RC candidate gates have not yet run.                                                                                                                                                                                               | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; $env:TEMP='G:\Jarvis\.runtime-cache\temp'; $env:TMP=$env:TEMP; npm run test:jarvis:resource-soak`                                                                                                                       |
| WINDOWS_PACKAGE     | Unsigned Windows package and package-safety scan                                                | `NOT RUN` | Not executed: hardened RC candidate gates have not yet run.                                                                                                                                                                                               | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; npm run build:win:unsigned -- --output-dir G:\Jarvis\releases\0.2.0-rc.1`                                                                                                                                               |
| NATIVE_ABI          | Source Node ABI restore and packaged Electron ABI/bindings smoke                                | `NOT RUN` | Not executed: hardened RC candidate gates have not yet run.                                                                                                                                                                                               | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; node --test test/jarvis/NativeAbiPackaging.test.js test/jarvis/PackagedRuntimeDependencies.test.js; npm run build:win:unsigned -- --output-dir G:\Jarvis\releases\0.2.0-rc.1`                                           |
| PACKAGED_OFFLINE    | Unpacked executable launch with process-scoped offline transport                                | `NOT RUN` | Not executed: hardened RC candidate gates have not yet run.                                                                                                                                                                                               | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; npm run smoke:win:unpacked -- --runtime-root G:\Jarvis\.runtime-cache\packaged-smoke --executable 'G:\Jarvis\releases\0.2.0-rc.1\win-unpacked\Jarvis Memory.exe'`                                                       |
| PACKAGED_RESTART    | Fresh isolated-profile real session persistence, reopen, and no-duplicate smoke                 | `NOT RUN` | Not executed: hardened RC candidate gates have not yet run.                                                                                                                                                                                               | `Set-Location G:\Jarvis\.worktrees\jarvis-all-day-runtime\app; npm run smoke:win:unpacked -- --runtime-root G:\Jarvis\.runtime-cache\packaged-smoke --executable 'G:\Jarvis\releases\0.2.0-rc.1\win-unpacked\Jarvis Memory.exe'`                                                       |
